...
public void testCheckSearchArticleBackground()
{
    ...
    protected void swipeElementToLeft(By by, String error_message) {
        WebElement element = waitForElementPresent(by, error_message, 200);
        ...
        Map<String, Object> params = new HashMap<>();
        params.put("startX", right_x);
        params.put("startY", middle_y);
        params.put("endX", left_x);
        params.put("endY", middle_y);
